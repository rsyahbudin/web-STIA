...
<head>
    ...
    <title>Katalog Active Pharmaceutical Ingredients - PT Gepi Pharma</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('apis.index') }}" class="text-red-600 px-3 py-2 rounded-md text-sm font-medium border-b-2 border-red-600">API</a>
