...
<head>
    ...
    <title>Katalog Produk Makanan - PT Gepi Pharma</title>
    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="{{ route('products.index') }}" class="text-red-600 px-3 py-2 rounded-md text-sm font-medium border-b-2 border-red-600">Produk Makanan</a>
        ...
        <div class="mobile-menu hidden md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white shadow-lg">
                ...
                <a href="{{ route('products.index') }}" class="text-red-600 block px-3 py-2 rounded-md text-base font-medium">Produk Makanan</a>
    ...
    <footer class="bg-gray-800 text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-gray-500">&copy; {{ date('Y') }} PT Gepi Pharma. All rights reserved.</p>
            </div>
        </div>
    </footer>
